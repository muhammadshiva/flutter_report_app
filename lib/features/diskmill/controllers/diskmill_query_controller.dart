...
class DiskmillQueryController extends GetxController {
  ...
  void validateForm() {
    ...
    if (batokMasukTxt.value.isEmpty) {
      batokMasukError.value = 'Sumber batok tidak boleh kosong';
      isValid = false;
    } else {
    ...
    if (hasilPisau02Txt.value.isEmpty) {
      hasilPisau02Error.value = 'Sumber batok tidak boleh kosong';
      isValid = false;
    } else {
    ...
    if (hasilPisau03Txt.value.isEmpty) {
      hasilPisau03Error.value = 'Sumber batok tidak boleh kosong';
      isValid = false;
    } else {
    ...
    if (keteranganTxt.value.isEmpty) {
      keteranganError.value = 'Sumber batok tidak boleh kosong';
      isValid = false;
    } else {
