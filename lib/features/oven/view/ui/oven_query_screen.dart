...
class OvenQueryScreen extends StatelessWidget {
  const OvenQueryScreen({super.key});

  @override
  Widget build(BuildContext context) {
    var controller = OvenQueryController.to;
                  ...
                  child: ListView(
                    children: [
                      ...
                      TextFieldLabelWidget(
                        title: 'Pengovenan',
                        initialValue: controller.pengovenanTxt.value,
                        onChanged: (value) {
                          controller.pengovenanTxt.value = value ?? '';
                        },
