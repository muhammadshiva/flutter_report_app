...
class AyakRotariQueryScreen extends StatelessWidget {
  const AyakRotariQueryScreen({super.key});

  @override
  Widget build(BuildContext context) {
    var controller = AyakRotariQueryController.to;
                ...
                child: ListView(
                  children: [
                    ...
                    TextFieldLabelWidget(
                      title: 'Batok Kotor',
                      unit: 'Kg',
                      initialValue: controller.batokKotorTxt.value,
                      onChanged: (value) {
                        controller.batokKotorTxt.value = value ?? '';
                      },
                      errorText: controller.batokKotorError,
                    ),
                    20.verticalSpace,
                    Text(
                      'Hasil',
                    ...
                    TextFieldLabelWidget(
                      title: 'Batok',
                      unit: 'Kg',
                      initialValue: controller.hasilBatokTxt.value,
                      onChanged: (value) {
                        controller.hasilBatokTxt.value = value ?? '';
                      },
                      errorText: controller.hasilBatokError,
                    ),
                    20.verticalSpace,
                    TextFieldLabelWidget(
                      title: 'Abu',
                      unit: 'Kg',
                      initialValue: controller.hasilAbuTxt.value,
                      onChanged: (value) {
                        controller.hasilAbuTxt.value = value ?? '';
                      },
                      errorText: controller.hasilAbuError,
                    ),
                    20.verticalSpace,
                    TextFieldNoteWidget(
