...
class BahanBakuDataItem extends StatelessWidget {
  const BahanBakuDataItem({
    super.key,
    required this.controller,
    required this.data,
  });

  final BahanBakuController controller;
              ...
              SizedBox(
                ...
                child: Wrap(
                  ...
                  children: [
                    richText(
                      title: 'Masuk',
                      subtitle: '${data.jumlahMasuk}',
                      units: 'Ton',
                    ),
                    richText(
                      title: 'Keluar',
                      subtitle: '${data.jumlahKeluar}',
                      units: 'Ton',
                    ),
                  ],
                ),
