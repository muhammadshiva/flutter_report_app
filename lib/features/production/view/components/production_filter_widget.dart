...
class ProductionFilterWidget extends StatelessWidget {
            ...
            child: DropdownButtonFormField<String>(
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(21),
                  borderSide: const BorderSide(color: ColorStyle.primary), // Warna garis tepi saat fokus
                ),
              ...
              items: <String>['Semua', 'Sumatera', 'Sulawesi'].map<DropdownMenuItem<String>>((String value) {
